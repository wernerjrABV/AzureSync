...
class SQLiteConnection:
    ...
    def init_schema(self):
        ...
        CREATE TABLE IF NOT EXISTS area_paths (id INTEGER PRIMARY KEY, organization TEXT, project TEXT, area_path TEXT, is_running INTEGER DEFAULT 0, sync_phase TEXT, sync_progress_current INTEGER, sync_progress_total INTEGER);
